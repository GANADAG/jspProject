...
<body>
		...
		<form action="idSearch.jsp" method="post">
			...
			<div class="d-inline-flex">
				<input type="text" name="m_id" class="form-control"
					style="width: 130px;" required="required" placeholder="아이디입력">
	...
	<div style="margin: 50px 50px;">
		<h5><%=m_id%>이미 가입된 아이디 입니다
		</h5>
		<img alt="" src="../image/jquery_img/image_01.png" width="60"
			align="left">
	...
	%>
	<div style="margin: 50px 50px;">
		<h5><%=m_id%>사용 가능한 아이디 입니다
		</h5>
		<img alt="" src="../image/jquery_img/image_03.png" width="60"
			align="left">

		<button type="button" class="btn btn-info"
			onclick="saveId('<%=m_id%>')">적용하기</button>
		<button type="button" class="btn btn-danger"
			onclick="location.href='idSearch.jsp'">다시입력</button>
	</div>
	<%
