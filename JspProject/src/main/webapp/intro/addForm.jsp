	...
	<div style="margin: 30px 50px">
		<form action="addAction.jsp" method="post">
			<table class="table table-bordered" style="width:600px;">
				...
				<th>생년월일</th>
				<td>
				<input type="date" name="birthday" class="form-control" value="2000-02-25" style="width:200px;">
				</td>
				</tr>
				...
				<tr>
					<th>성격</th>
					<td>
						<textarea style="width:px; height:"100px;" palceholder="자유롭게 서술"
				...
				<tr>
					<td colspan="2" align="center">
						<button type="submit" class="btn btn-outline-success">서버전송버튼</button>
					</td>
				</tr>
